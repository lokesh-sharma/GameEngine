...
Mesh::Mesh(Vertex* verticess, unsigned int numVertices)
{
    ...
    for(int i = 0 ; i< numVertices ; i++){
        vertices.push_back(*verticess[i].GetPos());
        normals.push_back(*verticess[i].GetNormal());
        texcord.push_back(*verticess[i].GetTexCoord());
    }
